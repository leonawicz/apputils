...
cat('<p style="text-align:center;"><img src="man/figures/sv_satellites_utils_app.png"></p><br>')
```
...
cat('[Package reference and function documentation](https://leonawicz.github.io/apputils/)')
```
